...
\usepackage{tikz} % required for \foreach
\usepackage{ifthen} % For logic
\usepackage{pifont} % for stars and symbols
...
\newcommand{\difficulty}[1]{%
	...
	\foreach \i in {1,...,5}{%
		\ifnum\i>#1
		\textcolor{gray!60}{\ding{72}}% empty star (gray)
		\else
		\textcolor{orange}{\ding{72}}% filled star (orange)
		\fi
	}%
}
%------------------ Page Setup ------------------%
